                    ...
                    <form action="EmpleadoSolicitarViajeServlet" method="post">
                        <div class="form-row">
                         ...
                         <div class="form-row">
                            <div class="form-group col-12 col-md-6">
                                ...
                                <input id="fechaInicio" name="fechaInicio" type="text" class="form-control" placeholder="Ciudad origen" required>
                            </div>
                            <div class="form-group col-12 col-md-6">
                                <div class="fontBig info-header">Fecha Fin:</div>
                                <input id="fechaFin" name="fechaFin" type="text" class="form-control" placeholder="Ciudad destino" required>
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <div class="form-group col-12 col-md-6">
                                ...
                                <div class="input-group">
                                    <input id="price" name="precio" type="text" class="form-control" placeholder="Coste del viaje en euros" required>
                        ...
                        <div class="form-row">
                            <div class="form-group text-center col-12">
                                <button type="submit" class="btn fontBig" click="alert(hola)">Enviar</button>
                            </div>
                        </div>
                    </form>
                </section>
