    ...
    <main id="content">
        ...
        <div class="container">
            ...
            <section class="col-8 centerHorizontal">
                <form action="CreateSupervisorServlet" method="post">
                    <div class="form-row">
                        <div class="form-group col-12 col-md-5">
                            <div class="fontBig info-header">Nombre:</div>
                            <input id="name" name="name" type="text" class="form-control" value="Nombre" required>
                        </div>
                        <div class="col-md-2"></div>
                        <div class="form-group col-12 col-md-5">
                            <div class="fontBig info-header">DNI:</div>
                            <input id="dni" name="dni" type="text" class="form-control" value="DNI" required>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-12 col-md-5">
                        ...
                        <div class="form-group col-12 col-md-5">
                            ...
                            <input id="dni" name="email" type="text" class="form-control" value="DNI" required>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-12 col-md-5">
                            <div class="fontBig info-header">Empresa:</div>
                            <input  id="firm" name="empresa" type="text" class="form-control" value="Empresa" required>
                        </div>
                        <div class="col-md-2"></div>
                        <div class="form-group col-12 col-md-5">
                            <div class="fontBig info-header">Departamento:</div>
                            <input id="department" name="departamento" type="text" class="form-control" value="Departamento" required>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-12">
                            <div class="fontBig info-header">Cuenta Bancaria:</div>
                            <input id="account" name="cuenta" type="text" class="form-control" value="Cuenta bancaria" required>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group text-center col-12">
                            <button type="submit" class="btn btn-save fontBig mr-3">Crear Supervisor</button>
                        </div>
                    </div>
                </form>
            </section>
