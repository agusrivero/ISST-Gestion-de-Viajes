        ...
        <main id="content">
            ...
            <div class="container">
                ...
                <section class="col-8 centerHorizontal">
        			<form id="formulario" class="bg-light" action="EmpleadoServlet" method="post">
                        <div class="form-row mb-3">
                            ...
                            <div class="form-group col-12 col-md-5">
                                ...
                                <input type="text" class="form-control" id="email" name="email" placeholder="Nombre y apellidos" required value="${email}">
                            </div>
                        ...
                        <div class="form-row mb-3">
                            <div class="form-group col-12 col-md-5">
                                ...
                                <input type="text" class="form-control" id="empresa" name="empresa" placeholder="Nombre de la empresa" required value="${empresa}">
                            </div>
                            <div class="col-md-2"></div>
                            <div class="form-group col-12 col-md-5">
                                <div class="fontBig info-header">Departamento:</div>
                                <input type="text" class="form-control" id="departamento" name="departamento" placeholder="Nombre del departamento" required value="${departamento}">
                            </div>
                        </div>
                        <div class="form-row mb-3">
                            <div class="form-group col-12 col-md-12">
                                <div class="fontBig info-header">Cuenta Bancaria:</div>
                                <input type="text" class="form-control" id="cuenta" name="cuenta" placeholder="Cuenta bancaria en la que se realizará el reembolso" required value="${cuenta}">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group text-center col-12">
                                <button type="submit" class="btn fontBig" href="EmpleadoServlet">Enviar</button>
                            </div>
                        </div>
                    </form>
                </section>
